...
async function getUsers(req, res) {
  try {
    ...
    // valid columns
    const validColumns = ["createdAt", "name", "email", "age", "isActive"];
...
async function createUserProfile(req, res) {
  ...
  try {
    ...
    if (error.name === "ValidationError") {
      return res
        .status(400)
        .json({ message: "Validation failed", errors: error.message });
    }
    return res
      .status(400)
...
async function getUserprofiles(req, res) {
  try {
    ...
    return res
      .status(201)
      .json({ message: "User profiles displayed successfully!", user });
  } catch (error) {
...
async function getUserProfileById(req, res) {
  ...
  try {
    ...
    return res
      .status(201)
      .json({ message: "User profile displayed successfully!", user });
  } catch (error) {
...
async function getImgs(req, res) {
  try {
    ...
    return res
      .status(201)
      .json({ message: "User images displayed successfully!", user });
  } catch (error) {
...
async function getImgById(req, res) {
  ...
  try {
    ...
    return res
      .status(201)
      .json({ message: "User Image displayed successfully!", user });
  } catch (err) {
    console.error(err);
...
async function deleteUserImage(req, res) {
  ...
  try {
    ...
    return res
      .status(400)
      .json({ message: "Error deleting user Image", error: error.message });
  }
}
